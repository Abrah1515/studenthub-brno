...
function run(command, args, options = {}) {
  ...
  return spawn(command, args, {
    cwd: root,
    env: { ...process.env, CI: process.env.CI ?? "true", DEMO_MODE: "true", ALLOW_LOCAL_FILE_STORE: "true", ALLOW_VERIFIED_FALLBACK: "true", LOCAL_STORE_FILE_NAME: "e2e-test-store.json", NEXT_PUBLIC_SUPABASE_URL: "", NEXT_PUBLIC_SUPABASE_ANON_KEY: "", SUPABASE_SERVICE_ROLE_KEY: "", NEXT_PUBLIC_ADS_ENABLED: "false", ...extraEnv },
    stdio: "inherit",
    ...spawnOptions,
  });
}
