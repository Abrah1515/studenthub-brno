export const adminSectionKeys = ["cities", "content_sources", "academic_events", "community_events", "community_forum", "places", "live_reports", "offers", "jobs", "marketplace", "service_requests", "buddy_posts", "contact_messages", "content_reports", "academic_event_conflicts", "analytics", "admin_users", "submissions", "source_review_queue"] as const;
