...
export function adminSectionAllowed(section: AdminSection, role: string) { if (section === "admin_users" || section === "profiles") return role === "super_admin"; if (role === "faculty_editor") return facultySections.has(section); return true; }
