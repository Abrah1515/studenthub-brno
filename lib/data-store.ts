...
export type TableName = "cities" | "campuses" | "service_requests" | "submissions" | "outbound_clicks" | "page_views" | "academic_events" | "places" | "offers" | "jobs" | "content_sources" | "source_sync_runs" | "source_review_queue" | "link_checks" | "content_publication_events";
...
function emptyStore(): LocalStore { return { cities: [], campuses: [], service_requests: [], submissions: [], outbound_clicks: [], page_views: [], academic_events: [], places: [], offers: [], jobs: [], content_sources: [], source_sync_runs: [], source_review_queue: [], link_checks: [], content_publication_events: [] }; }
