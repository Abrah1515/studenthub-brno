...
const nextConfig: NextConfig = {
  ...
  async headers() {
    return [
      ...
      { source: "/brno/partak/moje", headers: noIndexHeaders },
      ...
      { source: "/brno/nastaveni", headers: noIndexHeaders },
      { source: "/hlidac", headers: noIndexHeaders },
      { source: "/brno/hlidac", headers: noIndexHeaders },
      { source: "/brno/chat/:path*", headers: noIndexHeaders },
