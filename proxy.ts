...
function cityNotFoundResponse() {
  return new NextResponse(
    `<!doctype html><html lang="cs"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>Město není dostupné | StudentHub Brno</title><style>:root{color-scheme:light dark;font-family:Inter,ui-sans-serif,system-ui,sans-serif;background:#f8fafc;color:#0f172a}*{box-sizing:border-box}body{min-height:100vh;margin:0;display:grid;place-items:center;padding:24px;background:#f8fafc}.card{width:min(560px,100%);padding:32px;border:1px solid #e2e8f0;border-radius:8px;background:#fff;text-align:center;box-shadow:0 12px 32px rgba(15,23,42,.09)}.mark{width:48px;height:48px;margin:0 auto 18px;display:grid;place-items:center;border-radius:8px;background:#22c55e;color:#052e16;font-weight:900}h1{margin:0 0 10px;font-size:28px}p{margin:0 0 22px;color:#64748b;line-height:1.6}a{min-height:42px;padding:10px 16px;display:inline-flex;align-items:center;border-radius:7px;background:#4f46e5;color:#fff;font-weight:800;text-decoration:none}@media(prefers-color-scheme:dark){:root,body{background:#0f172a;color:#f8fafc}.card{border-color:#273244;background:#111827}.card p{color:#cbd5e1}a{background:#818cf8;color:#020617}}</style></head><body><main class="card"><div class="mark" aria-hidden="true">SH</div><h1>Tady nic není</h1><p>Tato městská edice není publikovaná. StudentHub je nyní veřejně dostupný pouze pro Brno.</p><a href="/brno">Přejít na StudentHub Brno</a></main></body></html>`,
    {
      status: 404,
      headers: {
