...
export const metadata: Metadata = { title: "Hlídač termínů a akcí", description: "Oblíbené termíny, připomínky a upozornění na důležité změny pro studenty v Brně.", alternates: { canonical: "/hlidac" } };
