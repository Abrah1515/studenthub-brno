...
export const metadata: Metadata = { title: "Moje škola, fakulta a ročník", description: "Nastavení personalizace StudentHubu bez registrace.", alternates: { canonical: "/nastaveni" }, robots: { index: false, follow: false } };
