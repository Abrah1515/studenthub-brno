...
export const metadata: Metadata = { title: "Moje škola a profil", description: "Nastavení personalizace a dobrovolného účtu StudentHub.", alternates: { canonical: "/brno/nastaveni" }, robots: { index: false, follow: false } };
