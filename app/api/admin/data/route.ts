...
export async function GET() {
  ...
  const names = ["cities", "academic_events", "places", "offers", "jobs", "service_requests", "submissions", "outbound_clicks", "page_views", "content_sources", "source_sync_runs", "source_review_queue", "link_checks", "content_publication_events", "buddy_posts", "buddy_join_requests", "content_reports"] as const;
