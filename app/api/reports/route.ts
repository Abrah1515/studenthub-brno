...
export async function POST(request: Request) {
  ...
  await insertRecord("content_reports", { target_type: parsed.data.targetType, target_id: parsed.data.targetId, reporter_session_hash: owner.hash, reason: parsed.data.reason, detail: parsed.data.detail, status: "new", city_id: parsed.data.cityId || "brno" });
