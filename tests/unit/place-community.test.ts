...
describe("komunitní katalog míst",()=>{
  ...
  it("nabízí rozšířené srozumitelné kategorie včetně městských vrstev",()=>{expect(placeCategoryCodes).toHaveLength(16);expect(placeCategoryCodes.map((code)=>placeCategoryLabels[code])).toEqual(["Restaurace","Kavárna","Hospoda a bar","Bistro a rychlé občerstvení","Menza","Knihovna","Studovna","Coworking","Veřejné toalety","Pítka","Sport a pohyb","Studentské služby","Poradenství a pomoc","Parky a zeleň","Lavičky a odpočinek","Ostatní"])});
