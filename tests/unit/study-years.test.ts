...
describe("červencový přechod ročníku", () => {
  ...
  it("dopočítá víceletou nepřítomnost a zastaví se na šestém", () => { expect(normalizePreference({ studyYear: 2, studyYearCycleStart: 2024 }, fallbackAcademicCatalog, new Date("2028-07-01T12:00:00Z")).studyYear).toBe(6); expect(normalizePreference({ studyYear: 6, studyYearCycleStart: 2024 }, fallbackAcademicCatalog, new Date("2030-07-01T12:00:00Z")).studyYear).toBe(6); });
